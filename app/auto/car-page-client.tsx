...
export function CarPageClient({ car: carProp, additionalImages }: CarPageClientProps) {
  const car = {
    ...
    description: [
  "This isn't just an SF90 Spider, it's a rolling celebration of Ferrari's heritage and craftsmanship, conceived for the 10th Anniversary Cavalcade and finished by Ferrari's Tailor Made atelier. Painted in glossy Blu Capri FYM.0502, this SF90 Spider is a singular tribute to design, passion, and precision performance, where every thread and brushstroke tells a story.",
  "The Blu Capri 4-layer paint, unique to this model, is set off by a historic two-tone Nero roof (BIC2) and a hand-applied livery in Acquamarina Blu, racing across the bonnet, doors, and spoiler. A bold Bianco King circle on each door with the number 70 echoes Ferrari's racing legacy, while the Italian and Dutch flag motifs at the door sills hint at the global passion Ferrari inspires.",
  "The cabin is a Tailor Made symphony of Argento Alcantara and Blue South Beach Ultrasuede, with each surface speaking to the soul of craftsmanship: Special edition racing seats in Argento 4978 Alcantara, with galletone perforations and contrasting Blu South Beach central accents. Tone-on-tone custom stitching in silver, blue, and black, each matching its respective panel with artistry. Cavallino headrests embroidered in custom thread. Aluminium F1 paddles finished in Blu Capri for a tactile connection between driver and machine.",
  "This Ferrari SF90 Spider Cavalcade isn't just a hypercar. It's history on wheels, created to celebrate Ferrari's most exclusive clients, hand-built by the artisans at the Tailor Made studio in Maranello. 1 of 1. Commissioned for an elite event. Immortalized in Blu Capri, laced with Acquamarina, and sealed with legacy."
],
